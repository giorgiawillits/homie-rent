...
## EXPENSES ##
d = Time.now
expenses = [{:name => "Rent", :amount => "4600", :date => d,
             :category => "Rent", :details => "June Rent",
             :deadline => d + 1.week, :paid_by => gige},
            {:name => "Toiletries", :amount => "10", :date => d-1.week,
             :category => "Supplies", :details => "Toilet Paper and Such",
             :deadline => d+1.day, :paid_by => anne},
            {:name => "Ramen", :amount => "24", :date => d-2.week,
             :category => "Supplies", :details => "Amazon Ramen Subscription",
             :deadline => d-1.day, :paid_by => gige},
            {:name => "Paper Towels", :amount => "23.49", :date => d-3.day,
             :category => "Supplies", :details => "Amazon Subscription",
             :deadline => d+3.day, :paid_by => val}]
